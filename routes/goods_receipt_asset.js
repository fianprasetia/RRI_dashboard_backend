...
router.post("/", controller.goods_receipt_asset.selectGoodsReceipt);
router.post("/insert", controller.goods_receipt_asset.insertGoodsReceipt);
router.post("/bycode", controller.goods_receipt_asset.selectGoodsReceiptByCode);
router.post("/update", controller.goods_receipt_asset.updateGoodsReceipt);
router.post("/posting", controller.goods_receipt_asset.updatePostingGoodsReceipt);
router.post("/delete", controller.goods_receipt_asset.deletePurchaseRequest);
